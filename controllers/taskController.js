...
const getUserDashboardData = async (req, res) => {
    try {
        ...
        .sort({ createdAt: -1 })
        .limit(10).select("title status priority dueDate createAt ")
...
module.exports = { getTasks, getTasksById, createTask, updateTaskStatus, updateTaskChickList, updateTask, deleteTask, getDashboardData, getUserDashboardData }
